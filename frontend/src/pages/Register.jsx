        ...
        <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 md:px-16 xl:px-32 relative py-12">
          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-10 text-center lg:text-left">
              <h3 className="text-3xl font-serif text-stone-900 tracking-tight mb-2">Create Account</h3>
              <p className="text-sm text-stone-500">Experience the art of fine jewellery.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mb-8">
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    {...register("name")}
                    className={`w-full px-4 py-3 bg-stone-50 border rounded-lg focus:ring-2 focus:ring-stone-900 focus:border-stone-900 transition-colors ${errors.name ? 'border-red-500' : 'border-stone-200'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-stone-50 border rounded-lg focus:ring-2 focus:ring-stone-900 focus:border-stone-900 transition-colors ${errors.confirmPassword ? 'border-red-500' : 'border-stone-200'}`}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-8 bg-stone-900 text-white py-3.5 rounded-lg hover:bg-stone-800 transition-all font-medium tracking-wide flex justify-center items-center disabled:bg-stone-400"
              >
                {isLoading ? (
